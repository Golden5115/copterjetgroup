...
const businesses = [
  {
    ...
    image: '/images/businesses/spares.jpg'
  },
  {
  ...
  },
  {
    ...
    image: '/images/businesses/asset-management.jpg'
  },
  {
    title: 'Services',
    ...
    image: '/images/businesses/services.jpg'
  },
  {
    title: 'Leasing',
    ...
    image: '/images/businesses/leasing.jpg'
  },
  {
...
function BusinessDivision({ data, index }: { data: typeof businesses[0]; index: number }) {
  ...
  return (
    <div ref={ref} className="relative py-14 lg:py-20 border-b border-white/[0.04] last:border-0 overflow-hidden group">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
        <div className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-8 lg:gap-16 items-center`}>
          ...
          {/* ── Image Side ── */}
          <div 
            className={`w-full lg:w-5/12 transition-all duration-[1.2s] cubic-ease ${
              isVisible 
          ...
          >
            <div className="relative w-full aspect-[3/2] max-w-md mx-auto overflow-hidden bg-[#0c2d4d] rounded-lg shadow-xl">
              ...
              <div 
                className={`absolute inset-0 transition-all duration-[1.4s] cubic-ease ${
          ...
          <div className={`w-full lg:w-7/12 ${isEven ? '' : 'lg:text-right'}`}>
            ...
            {/* Division label */}
            <div 
              className={`flex items-center gap-3 mb-4 transition-all duration-700 cubic-ease ${isEven ? '' : 'lg:justify-end'} ${
            ...
            {/* Title */}
            <h2 
              className={`text-2xl md:text-3xl lg:text-4xl font-bold text-white leading-[1.15] tracking-tight mb-5 transition-all duration-900 cubic-ease ${
            ...
            {/* Full Description */}
            <p 
              className={`text-white/55 text-[15px] md:text-base leading-[1.85] transition-all duration-900 cubic-ease ${isEven ? '' : 'lg:ml-auto'} ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
