...
export default function Footer() {
  ...
  const socials = [
    ...
    { label: 'LinkedIn', href: '#', brandBg: '#0A66C2', path: 'M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z' },
    ...
    { label: 'YouTube', href: 'https://youtu.be/ZqixKBVT45s?si=mmjxPlYgkbSXRb9i', brandBg: '#FF0000', path: 'M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z' }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 text-sm text-gray-300">
              <li><Link href="/businesses#spares-components" className="hover:text-copter-red hover:pl-2 transition-all block">CopterJet Spares & Components</Link></li>
              <li><Link href="/businesses#ground-equipment" className="hover:text-copter-red hover:pl-2 transition-all block">CopterJet Ground Equipment</Link></li>
              ...
              <li><Link href="/businesses#maintenance" className="hover:text-copter-red hover:pl-2 transition-all block">CopterJet Asset Management</Link></li>
              ...
              <li><Link href="/businesses#leasing" className="hover:text-copter-red hover:pl-2 transition-all block">CopterJet Leasing</Link></li>
              <li><Link href="/businesses#flight-operations" className="hover:text-copter-red hover:pl-2 transition-all block">CopterJet Flight Operations</Link></li>
            </ul>
          </div>
