      ...
      >
            ...
            <div className="flex items-center gap-5 ml-auto">
              ...
              <div className="hidden md:flex items-center gap-2">
                {[
                  ...
                  { label: 'LinkedIn', href: '#', brandBg: '#0077b5', path: 'M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z' },
        ...
        >
          ...
          <div className="max-w-[90rem] mx-auto px-4 xl:px-12 flex justify-between items-center h-[76px]">
            {/* FIXED LOGO SIZING */}
            <Link href="/" className="relative h-[45px] w-[190px] md:h-[65px] md:w-[290px] xl:h-[65px] xl:w-[290px] flex-shrink-0 block transition-all duration-300">
